...
const AdminLoginPage = () => {
  const { handlePassword, showPassword, adminLogin, loginAdmin, errorss } =
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="admin-form">
          ...
          <div>
            ...
            <input
              ...
              {...register("email")}
            />
            {errors.email && <strong className="error">{errorss}</strong>}
          </div>
          <div>
            ...
            {errors.password && <strong className="error">{errorss}</strong>}
